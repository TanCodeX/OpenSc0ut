...
export default function RepositoryCard({ repository }: RepositoryCardProps) {
  ...
  return (
    <div className="bg-[hsla(0,1.30%,15.50%,0.44)] backdrop-blur-md rounded-lg border border-[0.5px] border-[hsla(0,1.10%,36.10%,0.44)] overflow-hidden hover:border-gray-500 transition-all duration-300">
      <div className="p-5">
      ...
      <div className="px-5 py-3 bg-black/30 border-t border-[0.5px] border-[hsla(0,1.10%,36.10%,0.44)]">
        <a
