...
export default function GsocPage() {
  ...
  const filteredOrgs = useMemo(() => {
    ...
    // Filter by year (default to 2026)
    ...
    <div className="min-h-screen bg-black text-white transition-colors duration-300">
      <main>
        <SitePageHero
          ...
          description="Browse and filter GSoC organizations by tech stack, difficulty level, and interests to discover projects that match your skills and goals."
        />
