        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="/" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  Home
                </a>
              </li>
              <li>
                <a href="/about" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  About
                </a>
              </li>
              <li>
                <a href="/gsoc" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  GSOC
                </a>
              </li>
              <li>
                <a href="/ai-repo" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  AI Repo
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="/faq" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  FAQ
                </a>
              </li>
              <li>
                <a href="/contact-us" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  Contact
                </a>
              </li>
              <li>
                <a href="/terms" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  Terms
                </a>
              </li>
              <li>
                <a href="/privacy" className="text-gray-400 hover:text-[#FF0B55] transition-colors">
                  Privacy
                </a>
              </li>
            </ul>
