      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="/faq" className="text-gray-600 dark:text-gray-400 hover:text-[#FF0B55] dark:hover:text-[#FF0B55] transition-colors">
                  FAQ
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/terms" className="text-gray-600 dark:text-gray-400 hover:text-[#FF0B55] dark:hover:text-[#FF0B55] transition-colors">
                  Terms
                </a>
              </li>
              <li>
                <a href="/privacy" className="text-gray-600 dark:text-gray-400 hover:text-[#FF0B55] dark:hover:text-[#FF0B55] transition-colors">
                  Privacy
                </a>
              </li>
            </ul>
